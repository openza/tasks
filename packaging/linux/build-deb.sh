...
cli_publish_dir="$artifacts_dir/publish-cli-$runtime$channel_path_suffix"
...
rm -rf "$publish_dir" "$cli_publish_dir" "$package_root"
mkdir -p "$publish_dir" "$package_root/DEBIAN"
mkdir -p "$package_root/usr/lib/$app_library_name" "$package_root/usr/lib/$cli_library_name" "$package_root/usr/bin"
...
cp -a "$cli_publish_dir/." "$package_root/usr/lib/$cli_library_name/"
...
ln -s "/usr/lib/$cli_library_name/openza" "$package_root/usr/bin/$cli_launcher"
