...
- Treat the installed Linux app and its real data as a live daily driver. Use `OPENZA_TASKS_DATA_DIR` with an isolated directory for development, and do not build or install DEB/AppImage packages unless explicitly requested.
