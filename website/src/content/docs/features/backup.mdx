...
Openza Tasks can automatically back up your local SQLite database to protect your tasks from data loss.
...
- Production and dev builds use separate backup folders
